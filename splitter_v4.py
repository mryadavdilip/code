...
if __name__ == "__main__":
    ...
    parser.add_argument('--video_naming_convention', default="clip_$part", help='Naming pattern for output video parts, use $part')
    parser.add_argument('--thumbnail_naming_convention', default="thumb_$part", help='Naming pattern for thumbnail files, use $part')
